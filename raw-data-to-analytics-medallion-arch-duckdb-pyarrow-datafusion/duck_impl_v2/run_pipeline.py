...
def run_stage(script_name: str, run_id: str) -> None:
    ...
    try:
        ...
        # Abort downstream stages on failure to maintain database consistency
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    logger.info("Starting Daily Medallion ELT Pipeline Execution")
